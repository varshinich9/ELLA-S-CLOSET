...
<?php include('inc/header.php'); ?>  
  ...
  <div class="jumbotron p-4 p-md-5 text-white rounded bg-dark scroll_auto">
      ...
      <p class="lead my-3">Please, search customer by first name or contact no to update his record.</p>
    <div class="col-md-6 px-0 fleft">      
      <form method="post" action="update.php" style="border:1px solid #ccc;">
          <div class="container"><br>
        	
            <div class="form-label-group">
            <input class="form-control mr-sm-2" type="text" placeholder="Search" name="custinfo" aria-label="Search" autofocus>
				...
				if(empty($custinfo)){
					...
					if(mysqli_num_rows($custinfo_query_run)>0){
						...
						echo "<tr>
								...
								<td>$custinseam</td>
								<td>$custleg</td>
								<td><a href='update_current.php?upcid=$custid' class='btn btn-light'>Edit</a></td>
							  </tr>
							  ";
						}
						?>
